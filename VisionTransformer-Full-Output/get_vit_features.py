...
class StimPrep:
    ...
    def make_vit(self, stims):
        ...
        model = ViTModel.from_pretrained('google/vit-base-patch32-384',output_hidden_states=True)
...
StimPrep().make_embedding(emb_path='dummy.json', stim_path = embeddings_dct['raw_stims'][0], model='ViT')